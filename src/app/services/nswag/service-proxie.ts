...
export class UserServices {
    ...
    sendRegistrationOtp(email: string | undefined, firstname: string | undefined, username: string | undefined): Observable<ApiResponseMessageOfString> {
        let url_ = this.baseUrl + "/api/User/register/send-otp?";
        if (email === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSendRegistrationOtp(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSendRegistrationOtp(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ApiResponseMessageOfString>;
                }
            } else
    ...
    protected processSendRegistrationOtp(response: HttpResponseBase): Observable<ApiResponseMessageOfString> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    sendPasswordResetOtp(email: string | undefined, firstname: string | undefined): Observable<ApiResponseMessageOfString> {
        let url_ = this.baseUrl + "/api/User/forgot-password/send-otp?";
        if (email === null)
            throw new Error("The parameter 'email' cannot be null.");
        else if (email !== undefined)
            url_ += "email=" + encodeURIComponent("" + email) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSendPasswordResetOtp(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSendPasswordResetOtp(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ApiResponseMessageOfString>;
                }
            } else
    ...
    protected processSendPasswordResetOtp(response: HttpResponseBase): Observable<ApiResponseMessageOfString> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    verifyOtp(email: string | undefined, otp: string | undefined): Observable<ApiResponseMessageOfBoolean> {
        let url_ = this.baseUrl + "/api/User/verify-otp?";
        if (email === null)
            throw new Error("The parameter 'email' cannot be null.");
        else if (email !== undefined)
            url_ += "email=" + encodeURIComponent("" + email) + "&";
    ...
    protected processVerifyOtp(response: HttpResponseBase): Observable<ApiResponseMessageOfBoolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    completeRegistration(request: CompleteRegistrationRequest): Observable<ApiResponseMessageOfString> {
        let url_ = this.baseUrl + "/api/User/register/complete";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCompleteRegistration(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCompleteRegistration(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ApiResponseMessageOfString>;
                }
            } else
    ...
    protected processCompleteRegistration(response: HttpResponseBase): Observable<ApiResponseMessageOfString> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    resetPassword(request: ResetPasswordRequest): Observable<ApiResponseMessageOfString> {
        let url_ = this.baseUrl + "/api/User/forgot-password/reset";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processResetPassword(response: HttpResponseBase): Observable<ApiResponseMessageOfString> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    deleteUserEducation(educationId: string | undefined): Observable<ApiResponseMessageOfString> {
        ...
        if (educationId === null)
            throw new Error("The parameter 'educationId' cannot be null.");
    ...
    deleteUserWorkExperience(workexperienceId: string | undefined): Observable<ApiResponseMessageOfString> {
        ...
        if (workexperienceId === null)
            throw new Error("The parameter 'workexperienceId' cannot be null.");
    ...
    deleteUserCertificate(certificateId: string | undefined, appBinaryID: string | undefined): Observable<ApiResponseMessageOfString> {
        ...
        if (appBinaryID === null)
            throw new Error("The parameter 'appBinaryID' cannot be null.");
...
export class CompleteRegistrationRequest implements ICompleteRegistrationRequest {
    email!: string;
    username!: string;
    password!: string;
    firstName!: string;
            ...
            if (_data["address"]) {
                ...
                for (let key in _data["address"]) {
                    if (_data["address"].hasOwnProperty(key))
                        (<any>this.address)![key] = _data["address"][key];
                }
            }
        }
    }
        ...
        if (this.address) {
            ...
            for (let key in this.address) {
                if (this.address.hasOwnProperty(key))
                    (<any>data["address"])[key] = (<any>this.address)[key];
            }
        }
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.applicantJobLogsDtos)) {
            ...
            for (let item of this.applicantJobLogsDtos)
                data["applicantJobLogsDtos"].push(item.toJSON());
        }
        return data;
    }
}
...
export class GetAppointmentDto implements IGetAppointmentDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.scheduledDateTime = _data["scheduledDateTime"] ? new Date(_data["scheduledDateTime"].toString()) : <any>undefined;
            this.jobTitle = _data["jobTitle"];
            this.status = _data["status"];
            this.isConfirmed = _data["isConfirmed"];
            this.remarks = _data["remarks"];
    ...
    toJSON(data?: any) {
        ...
        data["scheduledDateTime"] = this.scheduledDateTime ? this.scheduledDateTime.toISOString() : <any>undefined;
        data["jobTitle"] = this.jobTitle;
        data["status"] = this.status;
        data["isConfirmed"] = this.isConfirmed;
        data["remarks"] = this.remarks;
